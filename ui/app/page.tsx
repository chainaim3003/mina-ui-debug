...
import { MCALevel1FirstWayCircuit1 } from '../../contracts/build/src/MCAFirstLevel1';
...
//const ZKAPP_ADDRESS = 'B62qib3NmJb8RbhpWm6y3FtQxjw68Qsn2zZsorcvXkoQLsyXscV3LR5'; // newly deployed one.
export default function Home() {
  ...
  const [verificationKey, setVerificationKey] = useState<null | VerificationKey>(null);
    ...
    const setup = async () => {
      try {
        if (!hasBeenSetup) {
          ...
          // await zkappWorkerClient.cacheZkapp();
