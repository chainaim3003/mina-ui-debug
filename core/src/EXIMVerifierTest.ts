...
import { EXIM, EXIMComplianceData } from './EXIMZKProgram.js';
import { EXIMVerifierSmartContract } from './EXIMVerifierSmartContract.js';
...
async function main() {
    ...
    const proof = await EXIM.proveCompliance(Field(0),EXIMcomplianceData)
