...
import { Mina, NetworkId, PrivateKey,CircuitString, Field } from 'o1js';
...
let zkApp = new MCALevel1FirstWayCircuit(zkAppAddress);

// compile the contract to create prover keys
console.log('compile the contract...');
await MCALevel1FirstWayCircuit.compile();
