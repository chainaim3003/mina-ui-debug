...
import { BusinessProcessIntegrityProof} from './BusinessProcessIntegrityZKProgram.js';
import { BusinessStandardDataIntegrityPublicOutput } from './BusinessStandardDataIntegrityZKProgram.js';
...
{*/
    ...
    @method async verifyComplianceWithProof(proof: BusinessProcessIntegrityProof) {
      ...
      console.log('  id ', publicOutput.businessProcessID, ' result ', publicOutput.result )
