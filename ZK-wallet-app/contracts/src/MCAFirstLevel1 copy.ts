import { Bool, Field, SmartContract, state, State, method, CircuitString, Struct, FlexibleProvablePure,Permissions } from 'o1js';
...
export class MCALevel1FirstWayCircuit1 extends SmartContract {
...
// 1) sending the verifcation key from zkworker to the page.tsx -> (setVerificationKey()) (avoiding the recompile)
// 2) convert this mca first level test into the latest version of corporate registration